...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'MotifFinderMEME'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from MotifFinderMEME.MotifFinderMEMEImpl import MotifFinderMEME  # noqa @IgnorePep8
impl_MotifFinderMEME = MotifFinderMEME(config)
